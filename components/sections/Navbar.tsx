      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3 group">
            ...
            >
              <span className="text-sm font-bold text-[#03080F]" style={{ fontFamily: "Syne, sans-serif" }}>
                R
              </span>
            </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="#contact" className="btn-outline px-5 py-2 rounded-lg text-sm">
              Contact
            </a>
            <a href="#contact" className="btn-primary px-5 py-2 rounded-lg text-sm">
