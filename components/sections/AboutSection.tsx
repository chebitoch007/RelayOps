...
const stack = [
  "Distributed Orchestration Engine", "Deterministic GPT-4 Validation", "High-Throughput n8n Matrices", 
  "Asynchronous Event Brokers", "Supabase Relational Layers", "Secure WhatsApp Transport Layers", 
  "Twilio Core SIP Infrastructure", "Isolated Call Telemetry Profiles", "ClickHouse Analytical Logging"
];
...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative py-32" style={{ background: "var(--bg-secondary)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            >
              RelayOps functions strictly as an architectural consulting engineering studio. We identify manual operational bottlenecks, map them into discrete mathematical workflows, and replace them with fault-tolerant systems.
            </motion.p>
            ...
            <div className="space-y-4">
              {designPrinciples.map((principle, i) => (
                ...
                >
                  <div className="w-8 h-8 rounded border border-white/10 flex items-center justify-center flex-shrink-0"
                    style={{ background: `${principle.color}08`, color: principle.color }}>
                    {principle.icon}
                  </div>
                  <div>
          ...
          >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xs text-[#64748B]">
                      Ingesting a maximum of 2 systemic build integrations per quarter for complete isolation testing.
                    </div>
                  </div>
                  <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                    <div className="w-2 h-2 rounded-full bg-[#F5A623] animate-pulse" />
                    <span className="text-xs mono text-[#F5A623] uppercase tracking-wider font-medium">READY //</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-5 glass-accent rounded-xl p-6">
              ...
              <div className="text-sm text-[#94A3B8] leading-relaxed font-light mb-0">
                "We operate under the assumption that manual data handoffs are unmitigated points of failure. Our core mandate is to deliver resilient, closed-loop orchestrations where uptime, security validation, and transparency metrics are hard-coded directly into the system architecture."
              </div>
            </div>
          </motion.div>
        </div>
